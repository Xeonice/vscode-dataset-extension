...
const dsDocs = {
  withoutDot: [
    ...
    },
    {
      ...
      "type": vscode.CompletionItemKind.Property,
      "body": [ "cacheSelection: ${1|false,true|}" ],
    ...
    },
    {
      ...
      "type": vscode.CompletionItemKind.Property,
      "body": [ "cascaseParams: (record, primaryKey) => { return {$1} }" ],
    ...
    },
    {
      "prefix": "type",
      "type": vscode.CompletionItemKind.Property,
      "body": [ "type: '${2|boolean,number,string,date,dateTime,time,week,month,year,email,url,intl,object|}'" ],
    ...
    },
    {
      "prefix": "format",
      "type": vscode.CompletionItemKind.Property,
      "body": [ "format: ${1|'uppercase','lowercase','capitalize'}" ],
    ...
    },
    {
      "prefix": "step",
      "type": vscode.CompletionItemKind.Property,
      "body": [ "step: ${1|1, { hour: 1\\, minute: 1\\, second: 1 }|}" ],
    ...
    },
    {
      "prefix": "lovDefineUrl",
      "type": vscode.CompletionItemKind.Property,
      "body": [ "lovDefineUrl: ${1|'',(code) => { return ''; }|}" ],
    ...
    },
    {
      "prefix": "lovQueryUrl",
      "type": vscode.CompletionItemKind.Property,
      "body": [ "lovQueryUrl: ${1|'',(code\\, config\\, { dataSet\\, params\\, data }) => { return ''; }|}" ],
    ...
    },
    {
      ...
      "type": vscode.CompletionItemKind.Property,
      "body": [ "lookupAxiosConfig: ${1|{ url: ''\\, method: '' },({ dataSet\\, record\\, params\\, lookupCode }) => { return {} }|}" ],
    ...
    },
    {
      ...
      "type": vscode.CompletionItemKind.Property,
      "body": [ "lovDefineAxiosConfig: ${1|{ url: ''\\, method: '' },(code) => { return {} }|}" ],
    ...
    },
    {
      ...
      "type": vscode.CompletionItemKind.Property,
      "body": [ "lovQueryAxiosConfig: ${1|'',(code, config, { dataSet\\, params\\, data }) => { return {} }|}" ],
    ...
    },
    {
      ...
      "type": vscode.CompletionItemKind.Property,
      "body": [ "transformRequest: (value, record) => {$1}" ],
    ...
    },
    {
      ...
      "type": vscode.CompletionItemKind.Property,
      "body": [ "transformResponse: (value, object) => {$1}" ],
      "description": "field-props - 在发送请求之前对数据进行处理",
  ...
  withDot: [
    ...
    },
    {
      "prefix": "delete",
      "type": vscode.CompletionItemKind.Method,
      "body": [ "delete(${1:records}, ${2:'confirmMessage'})" ],
    ...
    },
    {
      "prefix": "deleteAll",
      "type": vscode.CompletionItemKind.Method,
      "body": [ "deleteAll(${1:confirmMessage})" ],
    ...
    },
    {
      "prefix": "splice",
      "type": vscode.CompletionItemKind.Method,
      "body": [ "splice(${1:from}, ${2:deleteCount}, ${3:record})" ],
    ...
    },
    {
      "prefix": "find",
      "type": vscode.CompletionItemKind.Method,
      "body": [ "find((record, index, array) => {$1})" ],
    ...
    },
    {
      "prefix": "findIndex",
      "type": vscode.CompletionItemKind.Method,
      "body": [ "findIndex((record, index, array) => {$1})" ],
    ...
    },
    {
      "prefix": "forEach",
      "type": vscode.CompletionItemKind.Method,
      "body": [ "forEach((record, index, array) => {$1})" ],
    ...
    },
    {
      "prefix": "some",
      "type": vscode.CompletionItemKind.Method,
      "body": [ "some((record, index, array) => {$1})" ],
      "description": "ds-method - 根据函数遍历",
    ...
    },
    {
      "prefix": "every",
      "type": vscode.CompletionItemKind.Method,
      "body": [ "every((record, index, array) => {$1})" ],
    ...
    },
    {
      "prefix": "filter",
      "type": vscode.CompletionItemKind.Method,
      "body": [ "filter((record, index, array) => {$1})" ],
    ...
    },
    {
      "prefix": "reduce",
      "type": vscode.CompletionItemKind.Method,
      "body": [ "reduce((record, index, array) => {$1}, ${2:initialValue})" ],
    ...
    },
    {
      "prefix": "reduceRight",
      "type": vscode.CompletionItemKind.Method,
      "body": [ "reduceRight((record, index, array) => {$1}, ${2:initialValue})" ],
    ...
    },
    {
      "prefix": "indexOf",
      "type": vscode.CompletionItemKind.Method,
      "body": [ "indexOf(${1:record}, ${2:formIndex})" ],
